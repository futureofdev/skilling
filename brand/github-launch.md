...
The command-bearing source of truth is the repository README. It installs package `0.5.0`
persistently and starts `gh:futureofdev/skilling@v0.5.0#examples/welcome-skilling`. Brand copy
